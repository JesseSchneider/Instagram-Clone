...
@implementation EWEMediaFullScreenAnimator
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.presenting) {
        EWEMediaFullScreenViewController *fullScreenVC = (EWEMediaFullScreenViewController *)toViewController;
        ...
        EWEMediaFullScreenViewController *fullScreenVC = (EWEMediaFullScreenViewController *)fromViewController;

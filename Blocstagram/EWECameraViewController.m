...
@property (nonatomic, strong) EWECameraToolbar *cameraToolbar;

@end

@implementation EWECameraViewController
...
- (void) createViews {
    ...
    self.cameraToolbar = [[EWECameraToolbar alloc] initWithImageNames:@[@"rotate", @"road"]];

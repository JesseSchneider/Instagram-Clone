//
//  EWEPostToInstagramViewController.m
//  Blocstagram
//
//  Created by Jesse Schneider on 8/30/14.
...
@interface EWEPostToInstagramViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UIAlertViewDelegate, UIDocumentInteractionControllerDelegate>
...
@implementation EWEPostToInstagramViewController
...
- (void)viewDidLoad
{
    ...
    [self.filterCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
     ...
     [self.filterCollectionView registerClass:[UICollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"reusable view"];
...
- (void) addFiltersToQueue {
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (moodyFilter) {
            ...
            [self addCIImageToCollectionView:result withFilterTitle:NSLocalizedString(@"Random", @"Random Filter")];
        }
    }];
...
- (void)documentInteractionController:(UIDocumentInteractionController *)controller didEndSendingToApplication:(NSString *)application {
    [[NSNotificationCenter defaultCenter] postNotificationName:EWEImageFinishedNotification object:self];
}
/*
